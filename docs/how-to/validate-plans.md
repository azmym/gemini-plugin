...
- The validator uses Sonnet for reliable structured-output (`maxTurns: 6`). For post-cutoff claims, it can also call `gemini_search_grounded` to verify against live sources.
