...
- Cost discipline (opt-in deep research; brainstorm-off when you want to reduce per-prompt grounding)
...
**Model defaults:** gemini-3.8-flash for chat, gemini-3.1-pro-preview for generate.
